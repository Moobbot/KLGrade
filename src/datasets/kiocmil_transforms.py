"""
KIOCMIL Transforms - Current Active Version (V2)

This is the main transforms implementation, based on V2.
For older versions, see src/datasets/versions/

Photometric and geometric transforms for KIOCMIL dataset.

Includes:
- Photometric transforms (CLAHE, brightness, contrast, etc.)
- Geometric transforms (rotation, flip, affine, etc.)
- Normalization and tensor conversion utilities

Version History:
- V2 (current): Added geometric transforms with bbox support
- V1: Initial photometric transforms only
