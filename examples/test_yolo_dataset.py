...
from dataset import YoloDataset, visualize_dataset_sample, get_default_train_transform, get_default_val_transform
...
def test_yolo_dataset():
    ...
    train_transform = get_default_train_transform(img_size=(640, 640), use_augmentation=False)
