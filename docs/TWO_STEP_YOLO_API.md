...
- `knee_conf`: Knee detection confidence threshold (default: 0.5)
- `lesion_conf`: Lesion detection confidence threshold (default: 0.5)
- `include_visualization`: Return annotated image (default: false)
...
```json
{
  ...
  "annotated_image_base64": "...",  // if include_visualization=true
