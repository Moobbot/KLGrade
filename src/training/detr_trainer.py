...
class DETRTrainer:
    ...
    def setup_model(self):
        ...
        self.model = DetrForObjectDetection.from_pretrained(
            self.model_name, num_labels=self.num_classes, ignore_mismatched_sizes=True
        )
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            for batch in pbar:
                ...
                if (
                    self.use_focal_loss
                    and focal_loss_for_detr
                    and self.cb_weights is not None
                ):
            ...
            if (epoch + 1) % 10 == 0:
                self.save_checkpoint(
                    f"checkpoint_epoch_{epoch+1}.pt", epoch, avg_val_loss
                )
